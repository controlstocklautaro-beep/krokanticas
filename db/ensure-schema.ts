...
const statements = [
  ...
  `CREATE TABLE IF NOT EXISTS products (id TEXT PRIMARY KEY NOT NULL, business_id TEXT NOT NULL, name TEXT NOT NULL, description TEXT, price REAL NOT NULL, aliases TEXT NOT NULL DEFAULT '[]', active INTEGER NOT NULL DEFAULT 1, stock_status TEXT NOT NULL DEFAULT 'available', stock_quantity INTEGER, made_to_order INTEGER NOT NULL DEFAULT 0, created_at INTEGER NOT NULL, updated_at INTEGER NOT NULL)`,
